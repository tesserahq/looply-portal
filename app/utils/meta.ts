...
export const DEFAULT_META = {
  ...
  siteDescription: 'Looply Portal',
  siteUrl: 'looply.mylinden.family',
  siteImage: '/images/logo-full.png',
}
...
export function metaObject(
  ...
  const formattedTitle = title
    ? `${title} - ${DEFAULT_META.siteTitle}`
    : `${DEFAULT_META.siteTitle}`
  const formattedDescription = description ?? DEFAULT_META.siteDescription
  ...
  return [
    ...
    { property: 'og:url', content: DEFAULT_META.siteUrl },
