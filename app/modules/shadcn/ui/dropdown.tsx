...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      `focus:bg-accent data-[state=open]:bg-accent flex cursor-default items-center gap-2 rounded-sm
      px-2 py-1.5 text-sm outline-none select-none [&_svg]:pointer-events-none [&_svg]:size-4
      [&_svg]:shrink-0`,
      inset && 'pl-8',
      className
    )}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      rounded-sm px-2 py-1.5 text-sm transition-colors outline-none select-none
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    className={cn(
      ...
      rounded-sm py-1.5 pr-2 pl-8 text-sm transition-colors outline-none select-none
