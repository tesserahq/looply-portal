...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      `border-input ring-offset-background placeholder:text-muted-foreground hover:border-primary
      focus:ring-primary flex h-10 w-full items-center justify-between rounded border bg-transparent
      px-3 py-2 text-sm whitespace-nowrap transition-all duration-100 focus:ring-2
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      `focus:bg-accent focus:text-accent-foreground relative flex w-full cursor-default items-center
